/**
 * @file randnumgen.hpp
 * @brief Mersenne Twister random number generator (mt19937_64) wrapper.
 *
 * Public interface:
 *   rng.seed(int s)  -- deterministic seeding
 *   rng.rseed()      -- time- and hardware-entropy-based random seeding
 *   rng.ranf()       -- uniform real in [0.0, 1.0)
 *
 * A global instance `rng` is declared here and used throughout pvector and sim.
 */
#ifndef _RANDNUMGEN_
#define _RANDNUMGEN_
#include<chrono>
